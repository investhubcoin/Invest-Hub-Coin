...
In order to support loading of multiple wallets in ihc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ihc.cpp.
...
Changes to ihc.cpp
----------------------
ihc.cpp is the entry point into ihc-qt, and as such, will require some minor modifications to provide hooks for
