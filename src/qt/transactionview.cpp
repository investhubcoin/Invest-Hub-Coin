                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received IHC from zIHC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zIHC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zIHC));
