...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IHC features */
        {"ihc", "masternode", &masternode, true, true, false},
        {"ihc", "listmasternodes", &listmasternodes, true, true, false},
        {"ihc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ihc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ihc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ihc", "masternodedebug", &masternodedebug, true, true, false},
        {"ihc", "startmasternode", &startmasternode, true, true, false},
        {"ihc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ihc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ihc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ihc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ihc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ihc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ihc", "mnbudget", &mnbudget, true, true, false},
        {"ihc", "preparebudget", &preparebudget, true, true, false},
        {"ihc", "submitbudget", &submitbudget, true, true, false},
        {"ihc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ihc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ihc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ihc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ihc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ihc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ihc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ihc", "checkbudgets", &checkbudgets, true, true, false},
        {"ihc", "mnsync", &mnsync, true, true, false},
        {"ihc", "spork", &spork, true, true, false},
        {"ihc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ihc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ihcd, or the -server option to ihc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ihc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34101/\n";
}
