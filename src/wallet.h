...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 IHC at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zIHC send
enum ZerocoinSpendStatus {
    ZIHC_SPEND_OKAY = 0,                            // No error
    ZIHC_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZIHC_WALLET_LOCKED = 2,                         // Wallet was locked
    ZIHC_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZIHC_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZIHC_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZIHC_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZIHC_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZIHC_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZIHC_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZIHC_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZIHC_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZIHC_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZIHC_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZIHC_SPENT_USED_ZIHC = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZIHCAutoBackups(bool fEnabled)
    {
