...
RESOURCES += src/qt/ihc.qrc src/qt/ihc_locale.qrc

TRANSLATIONS += src/qt/locale/ihc_bg.ts \
                src/qt/locale/ihc_de.ts \
                src/qt/locale/ihc_en.ts \
                src/qt/locale/ihc_es.ts \
                src/qt/locale/ihc_fi.ts \
                src/qt/locale/ihc_fr.ts \
                src/qt/locale/ihc_it.ts \
                src/qt/locale/ihc_ja.ts \
                src/qt/locale/ihc_pl.ts \
                src/qt/locale/ihc_pt.ts \
                src/qt/locale/ihc_ru.ts \
                src/qt/locale/ihc_sk.ts \
                src/qt/locale/ihc_sv.ts \
                src/qt/locale/ihc_vi.ts \
                src/qt/locale/ihc_zh_CN.ts \
                src/qt/locale/ihc_zh_TW.ts
